    ...
    <div className="flex min-h-screen items-center justify-center bg-(--c-bg)">
      <main className="flex flex-col items-center justify-center px-4 py-16 text-center max-w-4xl">
        ...
        <div className="mb-8 relative">
          <div className="absolute inset-0 blur-3xl bg-(--c-primary-dim) rounded-full"></div>
          <div className="relative bg-(--c-primary)rounded-3xl shadow-2xl">
        ...
        <h1 className="text-5xl md:text-7xl font-bold text-white mb-6 tracking-tight">
          My <span className="text-(--c-accent)">Bini</span>
        </h1>
        ...
        <p className="text-(--c-muted) mb-12 max-w-xl">
        ...
        {/* Get Started Button */}
        <Link href="/wallet">
          <button className="bg-(--c-primary) hover:bg-(--c-primary-hover) text-white text-lg font-semibold py-4 px-12 rounded-2xl shadow-lg transition scale-125">
            Get Started
          </button>
        </Link>

        <p className="mt-8 text-sm text-(--c-muted-dim)">
...
function FeatureCard({
  ...
  return (
    <div className="bg-(--c-secondary)er border-(--c-border) rounded-2xl p-6 hover:border-(--c-border-accent) transition group">
      <div className="text-(--c-accent) mb-4 group-hover:scale-110 transition">
        {icon}
      </div>
      <h3 className="text-white font-semibold mb-2">{title}</h3>
      <p className="text-(--c-muted) text-sm">{description}</p>
    </div>
  );
}
