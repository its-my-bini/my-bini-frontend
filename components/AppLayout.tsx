...
export function AppLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex h-screen w-full bg-[var(--c-bg)] text-white">
      {/* DESKTOP SIDEBAR (Hidden on Mobile) */}
      <aside className="hidden md:flex w-80 flex-col border-r border-[var(--c-border-light)] bg-[var(--c-secondary)]">
        <div className="p-4 border-b border-[var(--c-border-light)] flex justify-between items-center">
      ...
      <main className="flex-1 flex flex-col relative h-full w-full overflow-hidden">
        ...
        {!isInChat && (
          <header className="md:hidden h-14 bg-[var(--c-secondary)] flex items-center justify-between px-4 border-b border-[var(--c-border-light)] shrink-0 z-10">
        ...
        <div className="flex-1 overflow-y-auto relative">
          {/* SVG Pattern Background - theme-adaptive */}
          {bgPattern.src && (
            <div
        ...
        {!isInChat && (
          <nav className="md:hidden h-16 bg-[var(--c-secondary)] border-t border-[var(--c-border-light)] flex items-center justify-around shrink-0 z-10 pb-safe">
